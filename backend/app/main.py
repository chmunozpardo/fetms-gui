import os
from app.routers import front_ends, health_check, noise_temperature, front_end, test_data, workmanship_amplitude, beam_pattern, lo_locking, if_spectrum
...
app = FastAPI(title='Contact.ly',
              description='APIs for contact Apis', version='0.1')
